...
sigs1=`./contractsv2 sign --addr=$addr1 --ep=test --sk=$sks1 qrtimelimit $TL  |tail -1|awk '{print $2}'`
sigs2=`./contractsv2 sign --addr=$addr2 --ep=test --sk=$sks2 qrtimelimit $TL  |tail -1|awk '{print $2}'`
sigs3=`./contractsv2 sign --addr=$addr3 --ep=test --sk=$sks3 qrtimelimit $TL  |tail -1|awk '{print $2}'`
sigs4=`./contractsv2 sign --addr=$addr4 --ep=test --sk=$sks4 qrtimelimit $TL  |tail -1|awk '{print $2}'`
sigs5=`./contractsv2 sign --addr=$addr5 --ep=test --sk=$sks5 qrtimelimit $TL  |tail -1|awk '{print $2}'`

./contractsv2 admin --ep=test --as=0a95533a110ee10bdaa902fed92e56f3f7709a532e22b5974c03c0251648a5d4 --sigs=$sigs1/$sigs2/$sigs3  qrtimelimit $TL
